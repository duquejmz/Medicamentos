    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: const Color.fromARGB(255, 244, 176, 239)),
        useMaterial3: true,
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 216, 164, 210),
      ),
      body: Padding(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  ...
                  borderSide: const BorderSide(
                      color: Color.fromARGB(255, 212, 162, 220)),
                ),
                enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(25),
                  borderSide: const BorderSide(
                      color: Color.fromARGB(255, 225, 171, 222)),
                ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                'Principio Activo: ${medicine['principio_activo'] ?? 'No disponible'}'),
                            Text(
                                'Fabricante: ${medicine['fabricante'] ?? 'No disponible'}'),
                            Text(
                                'Unidad de Dispensación: ${medicine['unidad_de_dispensacion'] ?? 'No disponible'}'),
                            Text(
                                'Concentración: ${medicine['concentracion'] ?? 'No disponible'}'),
                            Text(
                                'Unidad Base: ${medicine['unidad_base'] ?? 'No disponible'}'),
                            Text(
                                'Precio por Tableta: \$${medicine['precio_por_tableta'] ?? 'No disponible'}'),
                            Text(
                                'Factor de Precio: ${medicine['factoresprecio'] ?? 'No disponible'}'),
                            Text(
                                'Número Factor: ${medicine['numerofactor'] ?? 'No disponible'}'),
                          ],
                        ),
                      ),
                    );
